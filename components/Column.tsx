...
function Column({id, todos, index}: Props) {
    const [searchString, setNewTaskType, newtaskType] = useBoardStore((state) => [state.searchString, state.setNewTaskType, state.newtaskType])
                            ...
                            <div className='space-y-2'>
                                {todos?.map((todo, index) => {
                                    ...
                                    >
                                        {(provided) => (
                                            <TodoCard
                                                draggableProps={provided.draggableProps} dragHandleProps={provided.dragHandleProps} todo={todo}
                                                index={index}
                                                id={id}
